...
- Real-time monitoring of CPU, RAM, GPU, network, and disk usage  
- Live process table displaying memory and CPU consumption  
- Process management: sort, search, pause/resume, and terminate processes  
